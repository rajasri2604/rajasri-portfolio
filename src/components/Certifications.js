...
const certificates = [
  ...
  {
    title: 'UDEMY',
    img: ['/images/u1.jpeg', '/images/u2.jpeg', '/images/u3.jpg'],
    isCarousel: true,
  },
  {
    title: 'Internships',
    img: ['/images/o1.jpeg', '/images/h1.jpg'],
    isCarousel: true,
  },
];
...
const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-20 bg-white text-center overflow-x-hidden">
      <h2 className="text-3xl sm:text-4xl font-extrabold text-primaryPurple mb-10">Certifications</h2>
          ...
          >
            {cert.isCarousel ? (
              ...
              <img
                src={cert.img}
                alt={cert.title}
                className="w-full h-40 md:h-48 object-contain mb-4 rounded cursor-pointer"
